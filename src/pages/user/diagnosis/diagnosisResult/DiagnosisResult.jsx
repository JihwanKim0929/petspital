            ...
            <VStack w='100%'>
              ...
              <Show when={!isBelowMd}>
                <Box display='flex' align='left' w='100%' mt={6}>
                  <Image src={diagnosisResult.image_url} borderRadius='1rem' 
                ...
                <VStack w='100%' align='left'>
                  ...
                  <HStack mt={3} align='flex-start'>
                    <VStack mr={10}>
                      ...
                      <Text fontFamily='Pretendard Variable' fontSize={{base:'10px', md:'10px', lg:'14px'}} wordBreak='break-word'>(상기 질병을 대표하는 이미지입니다)</Text>
                    </VStack>
                  ...
                  <Box w='100%'>
                    ...
                    <VStack w='100%'>
                      ...
                      <VStack w='100%' align='center'>
                        <Image src={diagnosisResult.disease.image_url} borderRadius='1rem' 
                        boxSize={{base:'150px', md:'200px', lg:'300px'}} mt={6} />
                        <Text fontFamily='Pretendard Variable' fontSize={{base:'10px', md:'10px', lg:'14px'}}>(상기 질병을 대표하는 이미지입니다)</Text>
                        <VStack w='100%' align='left'>
                          <Flex>
                            <Text fontFamily='Pretendard Variable' fontSize={{base:'16px', md:'16px', lg:'20px'}} fontWeight='700' whiteSpace='nowrap'>질병명:</Text>
                            <Text fontFamily='Pretendard Variable' fontSize={{base:'16px', md:'16px', lg:'20px'}} ml={2} wordBreak='break-word'>{diagnosisResult.disease.name}</Text>
